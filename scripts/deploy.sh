...
export REDIS_PORT=$(aws ssm get-parameter --name "/fresh-kitchen/REDIS_PORT" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
...
export GOOGLE_PROJECT_ID=$(aws ssm get-parameter --name "/fresh-kitchen/GOOGLE_PROJECT_ID" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
...
export MAIL_USERNAME=$(aws ssm get-parameter --name "/fresh-kitchen/MAIL_USERNAME" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
export MAIL_PASSWORD=$(aws ssm get-parameter --name "/fresh-kitchen/MAIL_PASSWORD" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
export INQUIRY_ADMIN_EMAIL=$(aws ssm get-parameter --name "/fresh-kitchen/INQUIRY_ADMIN_EMAIL" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
export LEGAL_TERMS_URL=$(aws ssm get-parameter --name "/fresh-kitchen/LEGAL_TERMS_URL" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)
export LEGAL_PRIVACY_URL=$(aws ssm get-parameter --name "/fresh-kitchen/LEGAL_PRIVACY_URL" --with-decryption --query Parameter.Value --output text --region $AWS_REGION)

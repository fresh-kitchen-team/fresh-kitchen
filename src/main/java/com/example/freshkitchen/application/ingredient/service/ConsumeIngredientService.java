...
@Transactional
public class ConsumeIngredientService implements ConsumeIngredientUseCase {

    private final IngredientRepository ingredientRepository;
    private final Clock clock;

    @Override
    public ConsumeResult consume(Command command) {
        ...
        LocalDate consumedAt = LocalDate.now(clock);
        ingredient.markConsumed(consumedAt);

        return new ConsumeResult(consumedAt);
    }
}

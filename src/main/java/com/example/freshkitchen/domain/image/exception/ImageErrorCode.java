...
public enum ImageErrorCode implements ErrorCode {
    ...
    IMAGE_ASSET_ID_REQUIRED(HttpStatus.BAD_REQUEST, "IMAGE-400-4", "imageAssetId must not be null"),
    IMAGE_ASSET_ALREADY_ATTACHED(HttpStatus.BAD_REQUEST, "IMAGE-400-5", "image asset is already attached to ingredient"),
    IMAGE_ASSET_NOT_FOUND(HttpStatus.NOT_FOUND, "IMAGE-404-1", "image asset not found");

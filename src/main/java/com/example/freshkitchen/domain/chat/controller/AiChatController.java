...
import com.example.freshkitchen.global.exception.config.CustomUserDetails;
import com.example.freshkitchen.global.exception.dto.ApiResponse;
...
public class AiChatController {
    ...
    @Operation(summary = "채팅 기록 조회", description = "특정 채팅방의 상세 메시지 내역을 조회합니다.")
